  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/2 -left-40 w-96 h-96 bg-purple-500/10 rounded-full blur-3xl animate-pulse delay-700"></div>
        <div className="absolute bottom-20 right-1/4 w-64 h-64 bg-blue-400/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
      </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12 animate-fade-in">
          ...
          <p className="text-xl md:text-2xl text-blue-100 font-medium max-w-2xl mx-auto">
            Ton réseau pro commence maintenant
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 mb-12 animate-slide-up">
          <a
            href="https://www.instagram.com/https://www.instagram.com/vh_besancon_alumni/"
            target="_blank"
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300 hover:scale-105">
            ...
            <h3 className="text-xl font-bold text-white mb-2">Réseau d&apos;alumni</h3>
            <p className="text-blue-100">Connecte-toi avec les anciens du lycée partout dans le monde</p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300 hover:scale-105">
            ...
            <h3 className="text-xl font-bold text-white mb-2">Stages & jobs</h3>
            <p className="text-blue-100">Décroche ton stage ou ton premier emploi plus facilement</p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300 hover:scale-105">
            ...
            <h3 className="text-xl font-bold text-white mb-2">Événements & rencontres</h3>
            <p className="text-blue-100">Soirées, conférences et rencontres avec des pros inspirants</p>
          </div>
        </div>
          ...
          <div className="p-8 md:p-12">
            <div className="text-center mb-8">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Rejoins l&apos;asso dès aujourd&apos;hui !
              </h2>
              <p className="text-lg text-gray-600 mb-2">
                Tu es élève au Lycée Victor Hugo ? Adhère à l&apos;association pour construire ton futur réseau.
              </p>
              <div className="inline-flex items-center gap-2 text-sm text-blue-600 font-semibold bg-blue-50 px-4 py-2 rounded-full">
                ...
                Inscription en 2 minutes chrono
              </div>
            </div>
